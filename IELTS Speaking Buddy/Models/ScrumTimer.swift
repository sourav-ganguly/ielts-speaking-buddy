...
final class ScrumTimer: ObservableObject {
    ...
    @Published var percentTimeElapsed: Int = 0
    ...
    nonisolated private func update() {
        ...
        Task { @MainActor in
            ...
            percentTimeElapsed = Int(Double(secondsElapsed) * 100.0 / Double(lengthInSeconds))
...
extension Array<IeltsTestQuestion.Attendee> {
    var speakers: [Speaker] {
        if isEmpty {
            ...
            return map { Speaker(name: $0.name, isCompleted: false) }
        }
    }
}
